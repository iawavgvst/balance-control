...
- Скопируйте файл .env.example и укажите внутри данные для подключения к базе данных PostgreSQL (их можно найти в docker/docker-compose/yml в разделе pgsql).
